...
const Footer = () => {
  ...
  return (
    <footer className="pb-16 pt-10 pr-20">
      <div className="container">
        <div className="flex justify-between flex-col md:flex-row flex-wrap gap-[30px] ">
          <div>
            <img
              className="w-35 h-20 object-fill overflow-hidden"
              src={logo}
              alt=""
            />
          ...
          <p className="text-[16px] leading-7 font-[400] text-textColor mt-4">
              Copyright &#169; {year} developed by Sameer Akram & Momin Majeed all right reserved.
          </p>
      </div>
    </footer>
  );
