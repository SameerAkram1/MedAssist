...
import heroImage02 from "../assets/images/hero-img02.jfif";
import heroImage04 from "../assets/images/hero-img04.jfif";
import heroImage05 from "../assets/images/hero-img05.jfif";
        ...
        <div className="container">
          <div className="flex flex-col lg:flex-row gap-[90px] items-center justify-between">
            ...
            <div className="flex gap-[30px] justify-end">
              <div>
                <img src={heroImage04} className="w-full mt-[180px]" alt="" />
              {/*  <img src={heroImage05} className="w-full mb-[5px]" alt="" />*/}
              </div>
              <div className="mt-[30px]">
                <img src={heroImage02} className="w-full mb-[30px]" alt="" />
                <img src={heroImage05} className="w-full" alt="" />
              </div>
            </div>
          </div>
        </div>
